...
struct DataLoaderPerfStats {
    ...
    int64_t get_next_batch_direct_ns = 0;
    int64_t get_next_batch_swap_path_ns = 0;
    int64_t get_next_batch_swap_overhead_ns = 0;
    ...
    int64_t edge_compact_active_ns = 0;
    int64_t edge_finalize_ns = 0;
    int64_t edge_unaccounted_ns = 0;
    int64_t map_tensor_calls = 0;
    int64_t map_tensor_validate_ns = 0;
    int64_t map_tensor_cat_ns = 0;
    int64_t map_tensor_unique_ns = 0;
    int64_t map_tensor_bitmap_zero_ns = 0;
    int64_t map_tensor_bitmap_output_init_ns = 0;
    int64_t map_tensor_bitmap_mark_ns = 0;
    int64_t map_tensor_bitmap_count_ns = 0;
    int64_t map_tensor_bitmap_scan_ns = 0;
    int64_t map_tensor_bitmap_extract_ns = 0;
    int64_t map_tensor_bitmap_mask_ns = 0;
    int64_t map_tensor_bitmap_inverse_ns = 0;
    int64_t map_tensor_split_ns = 0;
    int64_t map_tensor_total_ns = 0;
    ...
    std::vector<int64_t> device_get_next_batch_direct_ns;
    std::vector<int64_t> device_get_next_batch_swap_path_ns;
    std::vector<int64_t> device_get_next_batch_swap_overhead_ns;
    ...
    std::vector<int64_t> device_edge_compact_active_ns;
    std::vector<int64_t> device_edge_finalize_ns;
    std::vector<int64_t> device_edge_unaccounted_ns;
...
class DataLoader {
   public:
    ...
    std::atomic<int64_t> get_next_batch_direct_ns_{0};
    std::atomic<int64_t> get_next_batch_swap_path_ns_{0};
    std::atomic<int64_t> get_next_batch_swap_overhead_ns_{0};
    ...
    std::atomic<int64_t> edge_compact_active_ns_{0};
    std::atomic<int64_t> edge_finalize_ns_{0};
    std::atomic<int64_t> edge_unaccounted_ns_{0};
    std::atomic<int64_t> map_tensor_calls_{0};
    std::atomic<int64_t> map_tensor_validate_ns_{0};
    std::atomic<int64_t> map_tensor_cat_ns_{0};
    std::atomic<int64_t> map_tensor_unique_ns_{0};
    std::atomic<int64_t> map_tensor_bitmap_zero_ns_{0};
    std::atomic<int64_t> map_tensor_bitmap_output_init_ns_{0};
    std::atomic<int64_t> map_tensor_bitmap_mark_ns_{0};
    std::atomic<int64_t> map_tensor_bitmap_count_ns_{0};
    std::atomic<int64_t> map_tensor_bitmap_scan_ns_{0};
    std::atomic<int64_t> map_tensor_bitmap_extract_ns_{0};
    std::atomic<int64_t> map_tensor_bitmap_mask_ns_{0};
    std::atomic<int64_t> map_tensor_bitmap_inverse_ns_{0};
    std::atomic<int64_t> map_tensor_split_ns_{0};
    std::atomic<int64_t> map_tensor_total_ns_{0};
    ...
    std::vector<int64_t> device_get_next_batch_direct_ns_;
    std::vector<int64_t> device_get_next_batch_swap_path_ns_;
    std::vector<int64_t> device_get_next_batch_swap_overhead_ns_;
    ...
    std::vector<int64_t> device_edge_compact_active_ns_;
    std::vector<int64_t> device_edge_finalize_ns_;
    std::vector<int64_t> device_edge_unaccounted_ns_;
