...
| <!-- row: stack_06_plus_bitmap_unique --> `main` | `previous_stack + GEGE_UNIQUE_BACKEND=bitmap, GEGE_UNIQUE_BITMAP_NUM_NODES=86054151` | `3` |  |  |  |  |  |  |  |  | `n/a` | 3-epoch FB86M single-GPU train-only importance stack run |
| <!-- row: stack_07_plus_fast_map_tensors --> `main` | `previous_stack + GEGE_FAST_MAP_TENSORS=1` | `3` |  |  |  |  |  |  |  |  | `n/a` | 3-epoch FB86M single-GPU train-only importance stack run |
| <!-- row: stack_08_plus_keep_storage_hot_between_epochs --> `main` | `previous_stack + GEGE_KEEP_STORAGE_HOT_BETWEEN_EPOCHS=1` | `3` |  |  |  |  |  |  |  |  | `n/a` | 3-epoch FB86M single-GPU train-only importance stack run |
