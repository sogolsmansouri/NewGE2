...
CHECKPOINT_ROOT="${GEGE_CHECKPOINT_ROOT:-/mnt/jli256/smansou2_ge2/checkpoints}"
LOGDIR="/tmp"
...
sed \
  ...
  -e "s#^  num_epochs:.*#  num_epochs: ${NUM_EPOCHS}#" \
...
log "Flags: GEGE_PARTITION_BUFFER_LP_FAST_PATH=$GEGE_PARTITION_BUFFER_LP_FAST_PATH GEGE_BUCKET_STREAMING_LP=$GEGE_BUCKET_STREAMING_LP GEGE_FAST_MAP_TENSORS=$GEGE_FAST_MAP_TENSORS GEGE_GPU_ACTIVE_EDGE_SHUFFLE=$GEGE_GPU_ACTIVE_EDGE_SHUFFLE"
